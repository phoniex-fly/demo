...
/**
 *
 * @ClassName: TaskFinacialVerify
 * @Description:TODO(描述这个类的作用)
 * @author: Shixiaoyan
 * @date: 2021年1月20日 上午10:12:43
 * @Copyright:
 */
@Component("finaciaVerify")
public class TaskFinacialVerify extends TaskState {
